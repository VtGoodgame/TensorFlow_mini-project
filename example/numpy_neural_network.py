...
print("Входные данные X (4 цветка × 4 признака):")
print(X)
...
print("Веса слоя 1 W1 (4×8):")
print(W1)
print(f"\nФорма W1: {W1.shape} — 32 параметра")

print("\nСмещения слоя 1 b1 (1×8):")
print(b1)
...
print("\nГрадиенты весов выходного слоя dW2 (8×3):")
print(dW2)
...
print("\nГрадиенты весов скрытого слоя dW1 (4×8):")
print(dW1)
...
print("\nФормула: новый_вес = старый_вес - learning_rate × градиент\n")
...
for i in range(3):
    ...
    print(f"  W2[0,{i}]: {old_val:+.4f} - {learning_rate} × ({grad:+.4f}) = {new_val:+.4f}  (изменение: {change:+.4f})")
